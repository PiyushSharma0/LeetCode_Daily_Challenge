...
class Solution {
  public int numOfWays(int[] nums) {
    // Generate Pascal's Triangle up to the required size
    comb = generate(nums.length + 1);
    // Calculate the number of ways and subtract 1 for the original ordering
  ...
  private int ways(List<Integer> nums) {
    ...
    // Split the numbers into left and right subtrees based on the root
